    ...
    function dashboard() {
        return {
            ...
            globalSettings: {
                ...
                cache: { enabled: true, ssd_cache_dir: '', ssd_cache_max_size: 'auto', hot_cache_max_size: '0', initial_cache_blocks: 256, hot_cache_only: false, eviction_idle_timeout: 30 },
                ...
                try {
                    const response = await fetch('/admin/api/global-settings', {
                        ...
                        body: JSON.stringify({
                            ...
                            eviction_idle_timeout: this.globalSettings.cache.eviction_idle_timeout,
